...
class TrainOptions(BaseOptions):
    ...
    def __init__(self): # pylint: disable=super-init-not-called
        ...
        req = self.parser.add_argument_group('Training Options')
        req.add_argument('--name', default='test_pointnav_exp', required=True, help='Name of the experiment')
        ...
        gen.add_argument('--num_workers', type=int, default=1,
        ...
        in_out.add_argument('--log_dir', default='/home/lzz/UPEN/logs', help='Directory to store logs')
        ...
        train.add_argument('--dataset_percentage', dest='dataset_percentage', type=float, default=0.7,
        ...
        train.add_argument('--test_steps', type=int, default=100, help='Testing frequency') #默认10000
        ...
        train.add_argument('--worker', type=str, dest='config_train_file',
        ...
        self.parser.add_argument('--ensemble_dir', type=str, dest='ensemble_dir', default='/home/lzz/UPEN/map_predictor/',
                                help='Path containing the experiments comprising the ensemble')
        ...
        self.parser.add_argument('--save_nav_images', dest='save_nav_images', default=True, action='store_true',
